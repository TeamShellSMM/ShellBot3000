describe('!rename', function () {
  ...
  it('successful', async function () {
    ...
    assert.equal(result,'<@256> The level level1" (XXX-XXX-XXX) has been renamed to "new long name" ')
    const level=await TEST.ts.getLevels().where({code:'XXX-XXX-XXX'}).first();
