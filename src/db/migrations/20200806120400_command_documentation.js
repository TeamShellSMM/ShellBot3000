exports.up = function (knex) {
  let insertJson = [
      ...
      },
      {
          ...
          "message": "Your one time password was incorrect. You can run !login in {{TeamName}}'s discord server to get another code"
      },
      {
      ...
      },
      {
          ...
          "message": "We got a row id, but we could not find it in the database"
      },
      {
      ...
      {
          "name": "error.noAdmin",
          "message": "You are not an admin in this team, you have no permission to do this."
      },
      {
          "name": "clear.noArgs",
      ...
      },
      {
          ...
          "message": " ‣You have earned {{1dp earned_points}} point{{plural earned_points}}"
      },
      {
      ...
      },
      {
          ...
          "message": " ‣You have already submitted a clear for {{{levelInfo}}}"
      },
      {
          "name": "clear.removeDifficulty",
          "message": "‣You have removed your difficulty vote for {{{levelInfo}}} {{{bam}}}"
      },
      {
          "name": "clear.addDifficulty",
          "message": " ‣You have voted {{1dp difficulty_vote}} as the difficulty for {{{levelInfo}}} {{{bam}}}"
      },
      {
          "name": "clear.alreadyDifficulty",
          "message": " ‣You haven't submitted a difficulty vote for {{{levelInfo}}} {{{think}}}"
      },
      {
          "name": "clear.alreadyNoDifficulty",
          "message": " ‣You have already voted {{difficulty_vote}} for {{{levelInfo}}} {{{think}}}"
      },
      {
      ...
      },
      {
          ...
          "message": " ‣You have not added a like for {{{levelInfo}}} {{{think}}}"
      },
      {
      ...
      },
      {
          ...
          "message": "{{BotName}} rolled a d97 and found this level for you"
      },
      {
          "name": "random.embedTitlePlayers",
          "message": "{{BotName}} rolled a d97 and found this level for {{players}}"
      },
      {
      ...
      },
      {
          ...
          "message": "You need to give a reason for the change (in quotation marks)!"
      },
      {
      ...
      },
      {
          ...
          "message": "Level is not in a valid fix status (this should not happen)!"
      },
      {
          "name": "approval.oldLevelNotFound",
          "message": "Old level could not be found after reupload (this should not happen)!"
      },
      {
          "name": "approval.tooManyDiscussionChannels",
          "message": "Your vote is saved but there are 50 discussion channels active right now so we can't make a new one for this level"
      },
      {
      ...
      },
      {
          ...
          "message": "This level is one step from being approved, we'd just like to see some fixes!"
      },
      {
      ...
      },
      {
          ...
          "message": "The necessary amount of reject/approval votes has not been reached yet!"
      },
      {
          "name": "approval.fixInstructionsCreator",
          "message": "If you want to fix these issues use **!reupload** (to get it approved really quickly) or if you don't want to just use **!refusefix** and the mods will decide if it's still acceptable."
      },
      {
      ...
      },
      {
          ...
          "message": "We're really sorry, but this level was rejected after you refused to reupload."
      },
      {
          "name": "approval.approveAfterRefuse",
          "message": "You didn't reupload your level, but it got approved for difficulty {{1dp difficulty}} anyway. Seems like the issues mentioned weren't a big deal."
      },
      {
          "name": "approval.rejectAfterFix",
          "message": "We're really sorry, but it seems there are still some issues after you reuploaded, so it got rejected for now."
      },
      {
          "name": "approval.approveAfterFix",
          "message": "You fixed your level up nicely and it got approved for difficulty {{1dp difficulty}}, good job!"
      },
      {
          "name": "approval.rejectAfterReupload",
          "message": "We're really sorry, but some kind of issues must have come up even though your level was already approved before. The level got rejected for now. Please check out the message below to see what's going on."
      },
      {
          "name": "approval.approveAfterReupload",
          "message": "This level was already approved before, and now your reupload is as well."
      },
      {
          "name": "approval.approveDeletion",
          "message": "A deletion request was approved and this level was removed from the list."
      },
      {
          "name": "approval.approveRerate",
          "message": "A rerate request was approved for this level and the difficulty got updated from {{oldDifficulty}} to {{difficulty}}. Thanks for the report."
      },
      {
      ...
      },
      {
          ...
          "message": "We're sorry, but your deletion request was rejected, we don't wanna take people's points away, so we'd like this one to stay in the list."
      },
      {
          "name": "approval.rejectRerate",
          "message": "Your rerate request was rejected, the difficulty of the level was NOT updated."
      },
      {
          "name": "approval.rejectVerifyClear",
          "message": "Your clear for this level was rejected, you need to provide valid proof that you actually completed this level."
      },
      {
          "name": "judge.levelRejected",
          "message": "Sorry, this level didn't quite make the cut for {{TeamName}}, but feel free to use the advice below to improve your level and resubmit it to us at later time"
      },
      {
      ...
      {
          "name": "judge.approved",
          "message": "This level was approved for difficulty: {{1dp difficulty}}!"
      },
      {
          "name": "judge.votedApprove",
          "message": "{{player}} voted for approval with difficulty {{1dp difficulty_vote}}:"
      },
      {
      ...
      {
          "name": "judge.votedFix",
          "message": "{{player}} voted for fix with difficulty {{1dp difficulty_vote}}:"
      },
      {
      ...
      },
      {
          ...
          "message": "Please provide a short message to the creator explaining your decision!"
      },
      {
      ...
      },
      {
          ...
          "message": "There is no valid label to identify this audit request. This should not happen!"
      },
      {
      ...
      },
      {
          ...
          "message": "You did not provide a code for the old level. The reupload command is `!reupload <old code> <new code> reason for reuploading`"
      },
      {
          "name": "reupload.noNewCode",
          "message": "You did not provide a code for the new level. The reupload command is `!reupload <old code> <new code> reason for reuploading`"
      },
      {
          "name": "reupload.invalidOldCode",
          "message": "You did not provide a valid code for the old level. The reupload command is `!reupload <old code> <new code> reason for reuploading`"
      },
      {
          "name": "reupload.invalidNewCode",
          "message": "You did not provide a valid code for the new level. The reupload command is `!reupload <old code> <new code> reason for reuploading`"
      },
      {
      ...
      },
      {
          ...
          "message": "Please provide a little message on why you reuploaded at the end of the command (in quotes)"
      },
      {
          "name": "reupload.differentCreator",
          "message": "The new level uploaded doesn't have the same creator as the old level"
      },
      {
          "name": "reupload.wrongApprovedStatus",
          "message": "The new level is not approved, pending or in a fix request"
      },
      {
          "name": "reupload.notEnoughPoints",
          "message": "Creator doesn't have enough points to upload a new level"
      },
      {
          "name": "reupload.haveReuploaded",
          "message": "Old level has already been reuploaded with Code {{code}}"
      },
      {
      ...
      },
      {
          ...
          "message": "Can't handle the request right now because there are already 50 open reupload requests (this should really never happen)!"
      },
      {
          "name": "reupload.reuploadNotify",
          "message": "This level has been reuploaded from {{oldCode}} to {{newCode}}."
      },
      {
          "name": "reupload.success",
          "message": "You have reuploaded '{{{level.level_name}}}' by {{level.creator}} with code `{{newCode}}`. {{{bam}}}"
      },
      {
          "name": "reupload.renamingInstructions",
          "message": " If you want to rename the new level, you can use !rename new-code level name."
      },
      {
          "name": "reupload.inReuploadQueue",
          "message": " Your level has also been put in the reupload queue, we'll get back to you shortly."
      },
      {
          "name": "ammendcode.notify",
          "message": "The level code has been ammended from `{{oldCode}}` to `{{newCode}}`."
      },
      {
          "name": "error.specialDiscordString",
          "message": "We can't process your command because it had special discord strings like <@666085542085001246> in it"
      },
      {
      ...
      },
      {
          ...
          "message": "There is already another member with name \"{{newName}}\""
      },
      {
      ...
      },
      {
          ...
          "message": "You have changed your name from \"{{oldName}}\" to \"{{newName}}\""
      },
      {
      ...
      {
          "name": "rename.success",
          "message": "The level \"{{{level_name}}}\" ({{code}}) has been renamed to \"{{{new_level_name}}}\" {{{bam}}}"
      },
      {
      ...
      },
      {
          ...
          "message": "This level has been reuploaded and is now awaiting approval!"
      },
      {
          "name": "pending.alreadyApprovedBefore",
          "message": "This level was already approved before so if everything's alright you can approve it (use **!fixapprove**)"
      },
      {
      ...
      },
      {
          ...
          "message": "This level has been reuploaded and is now awaiting a decision!"
      },
      {
          "name": "pending.refuseDescription",
          "message": "Refused by: Please check the fixvotes and decide if this is still acceptable to approve or not (use **!fixapprove** or **!fixreject** with a message)."
      },
      {
          "name": "pending.fixReuploadDescription",
          "message": "Please check if the mandatory fixes were made and make your decision (use **!fixapprove** or **!fixreject** with a message)."
      },
      {
          "name": "removeLevel.cant",
          "message": "You can't remove \"{{{level_name}}}\" by {{{creator}}}"
      },
      {
          "name": "removeLevel.success",
          "message": "You have removed \"{{{level_name}}}\" by {{{creator}}} {{{buzzyS}}}"
      },
      {
          "name": "removeLevel.noReason",
          "message": "You did not provide a reason to remove this level. If you want to reupload, we recommend using the `!reupload` command. If you want to remove it now and reupload it later make sure __you don't lose the old code__"
      },
      {
          "name": "removeLevel.alreadyRemoved",
          "message": "\"{{{level_name}}}\" by {{{creator}}} has already been removed"
      },
      {
          "name": "undoRemoveLevel.cant",
          "message": "You can't undo the removal of \"{{{level_name}}}\" by {{{creator}}}"
      },
      {
          "name": "undoRemoveLevel.noReason",
          "message": "Just leave a note why you're undoing the level remove"
      },
      {
      ...
      },
      {
          ...
          "message": "You have undid the status change of \"{{{level_name}}}\" by {{{creator}}} {{{bam}}}"
      },
      {
          "name": "error.reasonTooLong",
          "message": "Your reason/comment can't be longer than {{maxLength}}"
      },
      {
      ...
      },
      {
          ...
          "message": "You are not yet registered. You will have to register first by using `!register` in {{{RegistrationChannel}}}\n🇰🇷 `!help kr`\n🇷🇺 `!help ru`\n🌐 `!help lang`"
      },
      {
      ...
      },
      {
          ...
          "message": "The code `{{code}}` was not found in {{TeamName}}'s list."
      },
      {
      ...
      },
      {
          ...
          "message": "The level '{{{level.level_name}}}' is under 'Request to fix' status"
      },
      {
          "name": "error.levelIsRemoved",
          "message": "The level '{{{level.level_name}}}'  has been removed from {{TeamName}}'s list"
      },
      {
      ...
      },
      {
          ...
          "message": "There was something wrong with the secure tokens. Please try again"
      },
      {
          "name": "error.noSearch",
      ...
      },
      {
          ...
          "message": ", we found {{levelsFound}} level{{plural levelsFound}}."
      },
      {
          "name": "search.showingOnly",
          "message": " Showing only {{num_shown}} level{{plural num_shown}}"
      },
      {
          "name": "points.points",
          "message": "You have {{1dp player.earned_points.clearPoints}} clear point{{plural player.earned_points.clearPoints}}. You have submitted {{player.earned_points.levelsMade}} level{{plural player.earned_points.levelsMade}} {{#if player.earned_points.freeSubmissions}} ({{player.earned_points.freeSubmissions}} free submission{{plural player.earned_points.freeSubmissions}}){{/if}}."
      },
      {
          "name": "points.canUpload",
          "message": "You have enough points to upload a level {{{PigChamp}}}"
      },
      {
          "name": "points.cantUpload",
          "message": "You need {{1dp points_needed}} more point{{plural points_needed}} to upload a new level {{{buzzyS}}}. Check how the points are mapped on {{TeamURI}}"
      },
      {
          "name": "points.rank",
          "message": " You have earned the rank **{{player.rank.rank}}** {{{player.rank.pips}}}"
      },
      {
          "name": "difficulty.updated",
          "message": "Difficulty rating updated from {{1dp old_difficulty}} - {{1dp new_difficulty}}"
      },
      {
      ...
      },
      {
          ...
          "message": "`{{level.code}}` has already been submitted as '{{{level.level_name}}}' by {{level.creator}}"
      },
      {
          "name": "add.success",
          "message": "The level {{{level_name}}} ({{code}}) has been added {{{love}}}"
      },
      {
          "name": "add.notAllowed",
          "message": "Members aren't allowed to submit their own levels on this server."
      },
      {
          "name": "tags.noTags",
      ...
      {
          "name": "tags.noNew",
          "message": "No new tags added for \"{{{level_name}}}\" by \"{{creator}}\"\n"
      },
      {
          "name": "tags.noRemoved",
          "message": "No tags have been removed for \"{{{level_name}}}\" by \"{{creator}}\"\n"
      },
      {
          "name": "tags.haveNew",
          "message": "Tags added for \"{{{level_name}}}\" by \"{{creator}}\" {{{bam}}}\n"
      },
      {
          "name": "tags.haveRemoved",
          "message": "Tags removed for \"{{level_name}}\" by \"{{creator}} {{{bam}}}\"\n"
      },
      {
          "name": "tags.noPermission",
          "message": "You can't remove tags from \"{{{level_name}}}\" by \"{{creator}}\""
      },
      {
      ...
      },
      {
          ...
          "message": "You can't remove videos from \"{{{level_name}}}\" by \"{{creator}}\""
      },
      {
          "name": "addVids.haveNew",
          "message": "Clear videos added for \"{{{level_name}}}\" by \"{{creator}}\" {{{bam}}}\n"
      },
      {
      ...
      },
      {
          ...
          "message": "Clear videos removed for \"{{{level_name}}}\" by \"{{creator}}\" {{{bam}}}\n"
      },
      {
          "name": "addVids.noNew",
          "message": "No new videos added for \"{{{level_name}}}\" by \"{{creator}}\"\n"
      },
      {
          "name": "addVids.noRemoved",
          "message": "No videos have been removed for \"{{{level_name}}}\" by \"{{creator}}\"\n"
      },
      {
          "name": "register.already",
          "message": "You're already registered as **{{name}}**. If you want to change your name you can use `!nick new name`"
      },
      {
          "name": "register.nameTaken",
          "message": "'{{name}}' has already been registered by someone else. Please use another nickname"
      },
      {
          "name": "register.success",
          "message": "You are now registered as '{{name}}'.  {{{bam}}}\n ‣ You can find the levels in {{TeamURI}}/levels\n ‣ You can submit your clears with `!clear LEV-ELC-ODE` in {{{LevelClearChannel}}}\n ‣ You can also submit your clears in the website by logging in with `!login`\n ‣ English - `!help`\n 🇰🇷 `!help kr`\n 🇷🇺 `!help ru`\n 🌐 `!help lang`"
      },
      {
      ...
      },
      {
          ...
          "message": "{{registeredCount}} members have been registered with their discord name, {{alreadyRegisteredCount}} have been skipped because they were already registered."
      },
      {
          "name": "login.reply",
          "message": " You have requested a login token for the website. click the link below to login.:\n <{{loginLink}}> {{{bam}}}\n If you're on mobile, copy the link and paste it into your preferred browser app. If you open this link in an in-app browser, your login might not be saved properly. {{{buzzyS}}}\n This token will only be valid for 30 minutes"
      },
      {
          "name": "login.failedReply",
          "message": " It seems the bot couldn't send you a direct message with the login link, are you maybe blocking direct messages from non-friends? You can try this command again if you change your discord settings."
      },
      {
          "name": "makerid.noCode",
      ...
      },
      {
          ...
          "message": "You have updated your maker-id to {{code}} and maker-name to {{name}} {{{bam}}}"
      },
      {
      ...
      },
      {
          ...
          "message": "`{{code}}` is already what you have set for your maker-id "
      },
      {
      ...
      },
      {
          ...
          "message": "Your world was successfully set and should now show up on the worlds page"
      },
      {
          "name": "setworld.noMakerId",
          "message": "You need to set your Maker ID and Name first with !makerid XXX-XXX-XXX Name"
      },
      {
      ...
      },
      {
          ...
          "message": "The level \"{{{level.level_name}}}\", by {{level.creator}}, has changed code from `{{oldCode}}` to `{{newCode}}`"
      },
      {
          "name": "help.basic",
          "message": "You can find all the commands at <https://makerteams.net/features>"
      },
      {
          "name": "mock.userSuccess",
          "message": "You're now {{name}}. Identity theft is not a joke, Jim!"
      },
      {
      ...
      },
      {
          ...
          "message": "This level is already pending. This command only resets a level's status to PENDING"
      },
      {
          "name": "resetStatus.successful",
          "message": "\"{{{level_name}}}\" by {{{creator}}} has been reset to PENDING"
      },
      {
          "name": "vote.noVoteSubmitted",
          "message": "You have not submitted any votes for \"{{{level_name}}}\" by {{{creator}}}"
      },
      {
          "name": "vote.voteRemoved",
          "message": "You have removed your vote for \"{{{level_name}}}\" by {{{creator}}}"
      },
      {
          "name": "clearDifficulty.success",
          "message": "You have cleared the difficulty votes for \"{{{level_name}}}\" by {{{creator}}}"
      },
      {
          "name": "race.newRaceAdded",
          "message": "A new {{#if unofficial}}unofficial{{else}}official{{/if}} race has been added:"
      },
      {
      ...
      },
      {
          ...
          "message": "<@{{{discord_id}}}> has entered the race \"{{{name}}}\"."
      },
      {
      ...
      },
      {
          ...
          "message": "<@{{{discord_id}}}> just finished the race \"{{{name}}}\" (Rank: #{{{rank}}}). Please post some verification of your clear."
      },
      {
          "name": "race.raceStarted",
          "message": "{{{mentions}}}: The race \"{{{name}}}\" has just started, you will be racing each other on the following level. Good luck and have fun!"
      },
      {
          "name": "race.noParticipants",
          "message": "The race \"{{{name}}}\" did not have any participants and was removed!"
      },
      {
          "name": "race.raceFailed",
          "message": "{{{mentions}}}: The race \"{{{name}}}\" could not be started, no level was found that fits all the criteria. The race has been postponed by 5 minutes, please change the criterias!"
      },
      {
          "name": "race.raceEnded",
          "message": "{{{mentions}}}: The race \"{{{name}}}\" has just finished, congratulations to the winners:"
      },
      {
      ...
      },
      {
          ...
          "message": "You need at least {{{minimumPoints}}} clear points to be able to create unofficial races!"
      },
      {
          "name": "race.tooManyPoints",
          "message": "You are not allowed to join this race, this race needs you to have a certain amount of points!"
      },
      {
      ...
      },
      {
          ...
          "message": "No member with the name \"{{{name}}}\" was found in the members list."
      },
      {
      ...
      },
      {
          ...
          "message": "The discord id was sucessfully set on the member with the name \"{{{name}}}\"."
      },
      {
          "name": "requestRerate.noReason",
          "message": "You did not provide a reason to rerate this level, please provide a reason and the difficulty you think would be correct for this level."
      },
      {
          "name": "requestRerate.notApproved",
          "message": "The level you entered is not approved, difficulty can only be changed for approved levels."
      }
  ];
...
exports.down = function (knex) {
  return knex.schema.dropTable('command_permissions').dropTable('default_strings').dropTable('commands');
};
