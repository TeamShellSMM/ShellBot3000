exports.up = function (knex) {
  ...
  const newDefaultStrings = [
    ...
    },
    {
      ...
      message: 'Use this to rename another member.',
    },
    {
    ...
    },
    {
      ...
      message: 'This level is not an approved level.',
    },
    {
    ...
    },
    {
      ...
      message: 'Missing parameter. You have to enter something here.',
    },
    {
    ...
    {
      name: 'error.noVideos',
      message: "You didn't enter any video urls.",
    },
    {
      name: 'error.notUrls',
      message:
    ...
    },
    {
      ...
      message: 'You have to enter at least one valid member name.',
    },
    {
    ...
    },
    {
      ...
      message: 'This is not a valid discord id.',
    },
    {
    ...
    },
    {
      ...
      message: 'This is not a valid integer.',
    },
  ];
  ...
  return knex('commands')
    ...
    .then(() => {
      return knex('commands').where('name', 'randomtag').update({
        name: 'randomtags',
        aliases: 'randomtag',
        format:
          '!randomtags <TagName> <MinDifficulty> <MaxDifficulty>',
      });
    })
    .then(() => {
      return knex('command_permissions')
        .whereRaw(
          "command_id = (select id from commands where name = 'renamemember' limit 1)",
        )
        .del();
    })
    .then(() => {
