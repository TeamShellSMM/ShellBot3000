exports.up = function(knex) {
  ...
  .createTable('levels', function(t) {
    ...
    t.integer('guild_id').unsigned().references('teams.id').notNull();
    t.integer('creator').unsigned().references('members.id').notNull();
  ...
  .createTable('plays', function(t) {
    ...
    t.integer('guild_id').unsigned().references('teams.id').notNull();
    t.integer('player').unsigned().references('members.id').notNull();
  ...
  .createTable('team_settings', function(t) {
    ...
    t.integer('admin_id').unsigned().references('members.id').notNull();
  ...
  .createTable('tags', function(t) {
    ...
    t.dateTime('updated_at').nullable();
    t.dateTime('deleted_at').nullable();
    t.integer('admin_id').unsigned().references('members.id').nullable();
    t.integer('guild_id').unsigned().references('teams.id').notNull();
