...
module.exports={
  ...
  'clear.earnedPoints':' ‣You have earned {{1dp earned_points}} point{{plural earned_points}}', 
  ...
  'clear.addDifficulty':' ‣You have voted {{1dp difficulty_vote}} as the difficulty for {{{levelInfo}}} {{{bam}}}',
  ...
  'judge.approved':"This level was approved for difficulty: {{1dp difficulty}}!",
  'judge.votedApprove':'{{player}} voted for approval with difficulty {{1dp difficulty_vote}}:',
  'judge.votedReject':'{{player}} voted for rejection:',
  'judge.votedFix':'{{player}} voted for fix with difficulty {{1dp difficulty_vote}}:',
  ...
  'reupload.noNewCode':'You did not provide a code for the new level. The reupload command is `!reupload <old code> <new code> reason for reuploading`',
